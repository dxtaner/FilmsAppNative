...
| Navigation | [React Navigation (Stack + Drawer)](https://reactnavigation.org/) |
| State Management | [Redux Toolkit](https://redux-toolkit.js.org/) |
| API | [TMDB API](https://www.themoviedb.org/documentation/api) |
| UI | [Ionicons](https://ionic.io/ionicons), [react-native-linear-gradient](https://github.com/react-native-linear-gradient/react-native-linear-gradient) |
